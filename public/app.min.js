...
return fn(context,options);}});};module.exports=exports['default'];},{"../utils":22}],9:[function(require,module,exports){(function(global){(function(){'use strict';exports.__esModule=true;function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{'default':obj};}
...
+"</a></p>\n</div>\n</div>\n\n\n\n";},"useData":true});},{"hbsfy/runtime":23}],28:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"</span> &ndash; &copy; 2021 P<span class=\"w3-hide-small\">atrick </span>Cardona \n -\n      <span class=\"w3-hide-small\">Hébergement&nbsp;: </span><a title=\"site hébergeur\" \n      href=\"https://pages.github.com/\" \n      target=\"_blank\" rel=\"noreferrer noopener\" style=\"text-decoration: none\">\n      gh-pages\n      </a>\n    </footer>";},"useData":true});},{"hbsfy/runtime":23}],31:[function(require,module,exports){exports.masquer_aide=function(){$("#aide").hide();};exports.afficher_aide=function(){$("#aide").show();};exports.alterner_section_aide=function(id){let section=document.getElementById(id);if(section.className.indexOf("w3-show")==-1){section.className+=" w3-show";}else{section.className=section.className.replace(" w3-show","");}};},{}],32:[function(require,module,exports){const Popup=require('./messageModule.js').Popup;const popup=new Popup();var exercice={titre:""};exercice.init=function(){this.titre=document.getElementById("titre").textContent;return true;};exports.exercice=exercice;},{"./messageModule.js":34}],33:[function(require,module,exports){exports.filtrer=function(IDListe,motif){let filtre,ul,li,a,i,txtValue;filtre=motif.toUpperCase();ul=document.getElementById(IDListe);li=ul.getElementsByTagName("li");for(i=0;i<li.length;i++){a=li[i].getElementsByTagName("a")[0];txtValue=a.textContent||a.innerText;if(txtValue.toUpperCase().indexOf(filtre)>-1){li[i].style.display="";}else{li[i].style.display="none";}}}},{}],34:[function(require,module,exports){const infos=require('../../../static/config/popups.json').infos;class Popup{constructor(msgid='000'){this.msgid=msgid;this.message="Un message...";this.titre="Titre";}}
Popup.prototype.preparer=function(msgid){this.msgid=msgid;let info=infos[msgid];this.titre=info.titre;this.message=info.contenu;};Popup.prototype.afficherMessage=function(msgid){this.preparer(msgid);$("#titre_message").html(this.titre);$("#contenu_message").html(this.message);$("#notification").show();};exports.Popup=Popup;},{"../../../static/config/popups.json":67}],35:[function(require,module,exports){exports.derouler_navigation=function(){$("#menu_gauche").show();};exports.refermer_navigation=function(){$("#menu_gauche").hide();};},{}],36:[function(require,module,exports){exports.afficheRubrique=function(evt,nomRubrique){let i,rubriques,tablinks;rubriques=document.getElementsByClassName("rubrique");for(i=0;i<rubriques.length;i++){rubriques[i].style.display="none";}
...
$('#'+nomRubrique).show();evt.currentTarget.className+=" triadic";return true;};},{}],37:[function(require,module,exports){var profil={};profil.retourne=function(cle,defaut){if(localStorage.getItem(cle)){valeur=localStorage.getItem(cle);}else{valeur=defaut;}
return valeur;};profil.changeNiveau=function(){let niveau=$("#niveau_choisi").val();localStorage.setItem("appProfilNiveau",niveau);};exports.profil=profil;},{}],38:[function(require,module,exports){"use strict";const versionApp=require('../package.json').version;const app_name=require('../package.json').name;const description=require('../package.json').description;const origine_logo=require('../static/config/credit.json').origine;const url_logo=require('../static/config/credit.json').url;const credit_logo=require('../static/config/credit.json').credit;const MSG=require('../static/config/messages.json').msg;window.afficheRubrique=require('./lib/scripts/ongletModule.js').afficheRubrique;window.exercice=require('./lib/scripts/exerciceModule.js').exercice;window.profil=require('./lib/scripts/profilModule.js').profil;window.afficher_aide=require('./lib/scripts/aideModule.js').afficher_aide;window.masquer_aide=require('./lib/scripts/aideModule.js').masquer_aide;window.alterner_section_aide=require('./lib/scripts/aideModule.js').alterner_section_aide;window.filtrer=require('./lib/scripts/filtre.js').filtrer;window.derouler_navigation=require('./lib/scripts/navigation.js').derouler_navigation;window.refermer_navigation=require('./lib/scripts/navigation.js').refermer_navigation;const Handlebars=require('hbsfy/runtime');const Navigo=require('navigo/lib/navigo');const chibi=require('chibijs/chibi');Handlebars.registerHelper("capitalisePremiereLettre",function(sChaine){if(typeof sChaine==='string'){return sChaine.charAt(0).toUpperCase()+sChaine.slice(1);}
return null;});Handlebars.registerHelper("interpreteNiveau",function(sChiffre){let niveau="";let etalon=sChiffre;switch(etalon){case"5":niveau="Cinquième";break;case"3":niveau="Troisième";break;default:return"Tous";}
return niveau;});Handlebars.registerHelper("estDuNiveauRequis",function(sNiveau){let niveauProfil=profil.retourne("appProfilNiveau",false);if(niveauProfil!==false){if(niveauProfil!=="*"){niveauProfil+="e";if(sNiveau===niveauProfil){return true;}else{return false;}}}
return true;});Handlebars.registerHelper('encodeChaine',function(chaine){return new Handlebars.SafeString(chaine);});const niveaux=require('../static/config/niveaux.json').niveaux;const menuTemplate=require("./menus/menuTemplate.hbs");const menuExerciceTemplate=require("./menus/menuExerciceTemplate.hbs");const menuListeTemplate=require("./menus/menuListeTemplate.hbs");Handlebars.registerPartial("apropos",require("./composants/aproposTemplate.hbs"));Handlebars.registerPartial("licence",require("./composants/licenceTemplate.hbs"));Handlebars.registerPartial("prise_en_main",require("./aides/aidePriseEnMain.hbs"));const erreurTemplate=require("./pages/erreurTemplate.hbs");const accueilTemplate=require("./pages/accueilTemplate.hbs");const listeTemplate=require("./pages/listeTemplate.hbs");const accueilExerciceTemplate=require("./pages/accueilExerciceTemplate.hbs");const exerciceTemplate=require("./pages/exerciceTemplate.hbs");const consigneExerciceTemplate=require("./pages/consigneExerciceTemplate.hbs");const mentionsTemplate=require("./pages/mentionsTemplate.hbs");const aideTemplate=require("./pages/aideTemplate.hbs");const profilTemplate=require("./pages/profilTemplate.hbs");const formProfilTemplate=require("./pages/formProfilTemplate.hbs");const piedDePageTemplate=require("./composants/piedTemplate.hbs");const notificationTemplate=require("./composants/notificationTemplate.hbs");const zone_notification=notificationTemplate();window.addEventListener('load',()=>{const menu=$('#menu');const app=$('#app');const aide=$("#aide");const notification=$("#notification");const piedDePage=piedDePageTemplate({'version':versionApp});const dataMenuAccueil=require("../static/config/menu_accueil.json").menu;const menuAccueil=menuTemplate(dataMenuAccueil);const dataMenuListe=require("../static/config/menu_liste.json").menu;const dataMenuAide=require("../static/config/menu_aide.json").menu;const menuAide=menuTemplate(dataMenuAide);const dataMenuProfil=require("../static/config/menu_profil.json").menu;const menuProfil=menuTemplate(dataMenuProfil);const dataMenuModprefs=require("../static/config/menu_modprefs.json").menu;const menuModprefs=menuTemplate(dataMenuModprefs);const dataMenuAccueilExercice=require("../static/config/menu_accueil_exercice.json").menu;const dataMenuExercice=require("../static/config/menu_exercice.json").menu;const dataMenuMentionsExercice=require("../static/config/menu_mentions_exercice.json").menu;const dataMenuConsigneExercice=require("../static/config/menu_consigne_exercice.json").menu;let moduleJSONdata=require('../static/config/apropos.json');let rubriquesJSONdataApropos=require('../static/config/rubriques_apropos.json').rubriques;let modeleApropos={'app_name':app_name,'description':description,'module':moduleJSONdata,'rubs':rubriquesJSONdataApropos,'version':versionApp,'credit':credit_logo,'url':url_logo,'origine':origine_logo};let dataLicence=require("../static/config/licence.json").licence;let rubriquesJSONdataLicence=require('../static/config/rubriques_licence.json').rubriques;let texte_page_1=dataLicence.pages[0].texte;let texte_page_2=dataLicence.pages[1].texte;let now=new Date();let actuel=now.getFullYear();let modeleLicence={'debut':dataLicence.debut,'actuel':actuel,'auteur':dataLicence.auteur,'texte_page_1':texte_page_1,'texte_page_2':texte_page_2,"rubs":rubriquesJSONdataLicence};let contenu={'modeleApropos':modeleApropos,'modeleLicence':modeleLicence}
const SommaireAide=aideTemplate(contenu);var root="/"+app_name+"/";var useHash=true;var hash='#!';var router=new Navigo(root,useHash,hash);router.notFound(function(){const html=erreurTemplate({couleur:'yellow',titre:'Erreur 404 - Page introuvable !',message:'Ce chemin n\'existe pas.'});menu.html(menuAccueil)
app.html(html);});router.on({'aide':function(){app.html(SommaireAide);menu.html(menuAide);},'liste/exercices':function(){let niveau=profil.retourne("appProfilNiveau",0)
let JSONdata=require('../static/config/liste_exercices.json');let contenu={'info':JSONdata,'exercice':'exercice','cible':'exercice','niveau':niveau}
let html=listeTemplate(contenu);dataMenuListe.exercice='exercice';const menuListe=menuListeTemplate(dataMenuListe);menu.html(menuListe);app.html(html);},'exercice/:id':function(params){fetch("./static/data/exercice"+params.id+".json").then((response)=>{return response.json();}).then((data)=>{let contenu={};contenu.did=params.id;contenu.exercice='exercice';contenu.cible='exercice';contenu.consigne=data.consigne
let html=accueilExerciceTemplate(contenu);app.html(html);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuAccueilExercice.did=params.id;dataMenuAccueilExercice.exercice='exercice';dataMenuAccueilExercice.actionsMobile=[].slice.call(dataMenuAccueilExercice.actions).reverse();let menuD=menuExerciceTemplate(dataMenuAccueilExercice);menu.html(menuD);},'effectuer/exercice/:id':function(params){fetch("./static/data/exercice"+params.id+".json").then((response)=>{return response.json();}).then((data)=>{let contenu={};contenu.did=params.id;contenu.exercice='exercice';contenu.cible='exercice';contenu.titre=data.titre;let html=exerciceTemplate(contenu);app.html(html);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuExercice.did=params.id;dataMenuExercice.exercice='exercice';dataMenuExercice.actionsMobile=[].slice.call(dataMenuExercice.actions).reverse();let menuD=menuExerciceTemplate(dataMenuExercice);menu.html(menuD);},'mentions/exercice/:id':function(params){fetch("./static/data/exercice"+params.id+".json").then((response)=>{return response.json();}).then((data)=>{let contenu={};contenu.did=params.id;contenu.app_name=data.app_name;contenu.titre=data.titre;contenu.prof=data.prof;contenu.exercice='exercice';contenu.cible='exercice';let html=mentionsTemplate(contenu);app.html(html);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuMentionsExercice.did=params.id;dataMenuMentionsExercice.exercice='exercice';dataMenuMentionsExercice.cible='exercice';dataMenuMentionsExercice.actionsMobile=[].slice.call(dataMenuMentionsExercice.actions).reverse();let menuR=menuExerciceTemplate(dataMenuMentionsExercice);menu.html(menuR);},'consigne/exercice/:id':function(params){fetch("./static/data/exercice"+params.id+".json").then((response)=>{return response.json();}).then((data)=>{let contenu={};contenu.did=params.id;contenu.exercice='exercice';contenu.cible='exercice';contenu.consigne=data.consigne;let html=consigneExerciceTemplate(contenu);app.html(html);}).catch((err)=>{console.log("Erreur: "+err);});dataMenuConsigneExercice.did=params.id;dataMenuConsigneExercice.exercice='exercice';dataMenuConsigneExercice.actionsMobile=[].slice.call(dataMenuConsigneExercice.actions).reverse();let menuD=menuExerciceTemplate(dataMenuConsigneExercice);menu.html(menuD);},'profil':function(){let niveau=profil.retourne('appProfilNiveau','tous');let contenu={'niveau':niveau};let html=profilTemplate(contenu);app.html(html);menu.html(menuProfil);},'modprefs':function(){let contenu={'niveaux':niveaux};let html=formProfilTemplate(contenu);app.html(html);menu.html(menuModprefs);},'':function(){let html=accueilTemplate({"bienvenue":MSG.bienvenue});app.html(html);app.htmlAppend(piedDePage);menu.html(menuAccueil);menu.show();sessionStorage.clear();}}).resolve();});},{"../package.json":25,"../static/config/apropos.json":52,"../static/config/credit.json":53,"../static/config/licence.json":54,"../static/config/liste_exercices.json":55,"../static/config/menu_accueil.json":56,"../static/config/menu_accueil_exercice.json":57,"../static/config/menu_aide.json":58,"../static/config/menu_consigne_exercice.json":59,"../static/config/menu_exercice.json":60,"../static/config/menu_liste.json":61,"../static/config/menu_mentions_exercice.json":62,"../static/config/menu_modprefs.json":63,"../static/config/menu_profil.json":64,"../static/config/messages.json":65,"../static/config/niveaux.json":66,"../static/config/rubriques_apropos.json":68,"../static/config/rubriques_licence.json":69,"./aides/aidePriseEnMain.hbs":26,"./composants/aproposTemplate.hbs":27,"./composants/licenceTemplate.hbs":28,"./composants/notificationTemplate.hbs":29,"./composants/piedTemplate.hbs":30,"./lib/scripts/aideModule.js":31,"./lib/scripts/exerciceModule.js":32,"./lib/scripts/filtre.js":33,"./lib/scripts/navigation.js":35,"./lib/scripts/ongletModule.js":36,"./lib/scripts/profilModule.js":37,"./menus/menuExerciceTemplate.hbs":39,"./menus/menuListeTemplate.hbs":40,"./menus/menuTemplate.hbs":41,"./pages/accueilExerciceTemplate.hbs":42,"./pages/accueilTemplate.hbs":43,"./pages/aideTemplate.hbs":44,"./pages/consigneExerciceTemplate.hbs":45,"./pages/erreurTemplate.hbs":46,"./pages/exerciceTemplate.hbs":47,"./pages/formProfilTemplate.hbs":48,"./pages/listeTemplate.hbs":49,"./pages/mentionsTemplate.hbs":50,"./pages/profilTemplate.hbs":51,"chibijs/chibi":1,"hbsfy/runtime":23,"navigo/lib/navigo":24}],39:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data,blockParams,depths){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,alias5=container.lambda,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"\">\n"
+((stack1=lookupProperty(helpers,"with").call(alias1,(depth0!=null?lookupProperty(depth0,"contexte"):depth0),{"name":"with","hash":{},"fn":container.program(1,data,0,blockParams,depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":16,"column":0},"end":{"line":39,"column":9}}}))!=null?stack1:"");},"useData":true,"useDepths":true});},{"hbsfy/runtime":23}],41:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data){var stack1,helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
return undefined};return"  <a href=\""
...
+"\">\n"
+((stack1=lookupProperty(helpers,"with").call(alias1,(depth0!=null?lookupProperty(depth0,"contexte"):depth0),{"name":"with","hash":{},"fn":container.program(3,data,0,blockParams,depths),"inverse":container.noop,"data":data,"loc":{"start":{"line":26,"column":0},"end":{"line":47,"column":9}}}))!=null?stack1:"");},"useData":true,"useDepths":true});},{"hbsfy/runtime":23}],42:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data){var helper,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"\n  </p>\n</div>\n</div>";},"useData":true});},{"hbsfy/runtime":23}],43:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data){var stack1,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"    </ul>\n</div>\n\n</div>\n";},"useData":true,"useDepths":true});},{"hbsfy/runtime":23}],50:[function(require,module,exports){var HandlebarsCompiler=require('hbsfy/runtime');module.exports=HandlebarsCompiler.template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data){var helper,alias1=depth0!=null?depth0:(container.nullContext||{}),alias2=container.hooks.helperMissing,alias3="function",alias4=container.escapeExpression,lookupProperty=container.lookupProperty||function(parent,propertyName){if(Object.prototype.hasOwnProperty.call(parent,propertyName)){return parent[propertyName];}
...
+"</span></td>\n</tr>\n</table>\n</div>\n\n</div>\n";},"useData":true});},{"hbsfy/runtime":23}],52:[function(require,module,exports){module.exports=[{"appname":"Modèle d'application (PWA) : Skelapp","auteur":"Patrick Cardona","site":"http://browserify.org/","licence":"GPL-3","code":"https://github.com/pcardona34/skelapp"},{"appname":"Agrégateur de scripts (bundle) : Browserify","auteur":"Browserify.org","site":"http://browserify.org/","licence":"MIT","code":"https://github.com/browserify"},{"appname":"Serveur de développement : Budo","auteur":"Matt DesLauriers","site":"https://github.com/mattdesl/budo/blob/master/README.md","licence":"MIT","code":"https://github.com/mattdesl/budo"},{"appname":"Manipulation du DOM : Chibi","auteur":"Kyle Barrow","site":"https://github.com/kylebarrow/chibi","licence":"MIT","code":"https://github.com/kylebarrow/chibi"},{"appname":"Minification du code CSS : cleanCSS","auteur":"Jakub Pawlowicz","site":"https://www.npmjs.com/package/clean-css","licence":"MIT","code":"https://github.com/jakubpawlowicz/clean-css"},{"appname":"Template : Handlebars","auteur":"Yehuda Katz","site":"https://handlebarsjs.com/","licence":"MIT","code":"https://github.com/wycats/handlebars.js"},{"appname":"Handlebars avec Browserify : hbsfy","auteur":"Esa-Matti Suuronen","site":"https://www.npmjs.com/package/hbsfy","licence":"MIT","code":"https://github.com/epeli/node-hbsfy"},{"appname":"Icones : IcoMoon Free Version","auteur":"Keyamoon","site":"https://icomoon.io/","licence":"GPL / CC BY 4.0","code":"https://github.com/Keyamoon/IcoMoon-Free/archive/master.zip"},{"appname":"Minification du code JS : jsmin","auteur":"D. Crockford, F. Marcia, P. Krumins","site":"https://www.npmjs.com/package/jsmin","licence":"All right reserved","code":"https://github.com/pkrumins/node-jsmin"},{"appname":"Routage : Navigo","auteur":"Krasimir Tsonev","site":"https://github.com/krasimir/navigo","licence":"MIT","code":"https://github.com/krasimir/navigo"},{"appname":"Service Worker : vanilla-pwa","auteur":"Arjun Mahishi","site":"https://www.npmjs.com/package/vanilla-pwa","licence":"MIT","code":"https://github.com/arjunmahishi/vanilla-pwa"},{"appname":"Style : W3.css","auteur":"W3schools","site":"https://www.w3schools.com/w3css/default.asp","licence":"Usage libre","code":"https://github.com/JaniRefsnes/w3css"}]},{}],53:[function(require,module,exports){module.exports={"credit":"Domaine public","origine":"Provient de ...","url":"http://qqpart.org"}},{}],54:[function(require,module,exports){module.exports={"licence":{"auteur":"Patrick Cardona","debut":"2020","pages":[{"texte":"Le code JavaScript de cette page est un logiciel libre. Vous pouvez le redistribuer et/ou le modifier selon les termes de la licence GNU General Public License (GNU GPL) telle que publiée par la Free  Software Foundation, en version 3 de la licence, ou (à votre discrétion) toute version ultérieure. Le code est distribué SANS AUCUNE GARANTIE ; sans même la garantie implicite de MARCHANDABILITÉ ou d'ADÉQUATION À UN BUT PARTICULIER. Consultez la GNU GPL pour plus de détails."},{"texte":"En tant que permission supplémentaire selon les termes de la GNU GPL version 3 section 7, vous pouvez distribuer des formes « non-source » (par ex., minimisées ou compactées) de ce code sans la copie de la GNU GPL normalement requise section 4, à condition d'inclure cette notice de licence et une URL par laquelle les destinataires peuvent accéder au code source correspondant.<br><br>Consultez la licence GNU GPL pour plus de détails:<br /><a href='http://www.gnu.org/licenses/' target='_blank'>http://www.gnu.org/licenses/</a>."}]}}},{}],55:[function(require,module,exports){module.exports=[{"id":"51","titre":"La rose","niveau":"5e"},{"id":"31","titre":"Le cerf","niveau":"3e"}]},{}],56:[function(require,module,exports){module.exports={"menu":{"couleur":"fonce","contexte":{"bouton":true,"titre":"_mon_application_","icone":"☰","action":"derouler_navigation()"},"items":[{"icone":"<i class='icon-liste'></i>","legende":"Exercices","lien":"#!liste/exercices"}],"actions":[{"bouton":false,"icone":"<i class='icon-aide'></i>","legende":"Aide","lien":"#!aide"},{"bouton":false,"icone":"<i class='icon-profil'></i>","legende":"Profil","lien":"#!profil"}]}}},{}],57:[function(require,module,exports){module.exports={"menu":{"couleur":"blue-gray","contexte":{"bouton":false,"titre":"Choix","icone":"<i class='icon-retourner'></i>","action":"#!liste/exercices"},"items":[],"actions":[{"bouton":false,"icone":"<i class='icon-plume'></i>","legende":"Effectuer cet exercice","lien":"#!effectuer/exercice"},{"bouton":false,"icone":"<i class='icon-info'></i>","legende":"Mentions légales","lien":"#!mentions/exercice"}]}}},{}],58:[function(require,module,exports){module.exports={"menu":{"couleur":"clair","contexte":{"bouton":false,"titre":"Aide","icone":"<i class='icon-retourner'></i>","action":"#!"},"items":[],"actions":[]}}},{}],59:[function(require,module,exports){module.exports={"menu":{"did":"","couleur":"blue-gray","contexte":{"bouton":false,"titre":"Consigne","icone":"<i class='icon-retourner'></i>","action":"#!liste/exercices"},"items":[],"actions":[{"bouton":false,"icone":"<i class='icon-plume'></i>","legende":"Reprendre l'exercice","lien":"#!effectuer/exercice"}]}}},{}],60:[function(require,module,exports){module.exports={"menu":{"did":"","couleur":"blue-gray","contexte":{"bouton":false,"titre":"Exécution","icone":"<i class='icon-retourner'></i>","action":"#!liste/exercices"},"items":[],"actions":[{"bouton":false,"icone":"<i class='icon-info'></i>","legende":"Mentions légales","lien":"#!mentions/exercice"},{"bouton":false,"icone":"<i class='icon-consigne'></i>","legende":"Consigne","lien":"#!consigne/exercice"}]}}},{}],61:[function(require,module,exports){module.exports={"menu":{"exercice":"exercice","couleur":"blue-gray","contexte":{"bouton":false,"titre":"Liste","icone":"<i class='icon-retourner'></i>","action":"#!"},"items":[],"actions":[{"bouton":true,"icone":"<i class='icon-recherche'></i>","legende":"Filtrer la liste","lien":"$('#panneau_recherche').toggle()"}]}}},{}],62:[function(require,module,exports){module.exports={"menu":{"did":"","couleur":"blue-gray","contexte":{"bouton":false,"titre":"Mentions légales","icone":"<i class='icon-retourner'></i>","action":"#!liste/exercices"},"items":[],"actions":[{"bouton":false,"icone":"<i class='icon-plume'></i>","legende":"Reprendre l'exercice","lien":"#!effectuer/exercice"}]}}},{}],63:[function(require,module,exports){module.exports={"menu":{"couleur":"clair","contexte":{"bouton":false,"titre":"Modification du profil","icone":"<i class='icon-gauche'></i>","action":"#!profil"},"items":[],"actions":[{"bouton":false,"icone":"<i class='icon-finir'></i>","legende":"Appliquer","lien":"#!profil"}]}}},{}],64:[function(require,module,exports){module.exports={"menu":{"couleur":"clair","contexte":{"bouton":false,"titre":"Profil","icone":"<i class='icon-retourner'></i>","action":"#!"},"items":[],"actions":[{"bouton":false,"icone":"<i class='icon-editer'></i>","legende":"Modifier le profil","lien":"#!modprefs"}]}}},{}],65:[function(require,module,exports){module.exports={"description":"Messages de l'interface","msg":{"bienvenue":"Bienvenue dans votre application !"}}},{}],66:[function(require,module,exports){module.exports={"niveaux":[{"chiffre":"5","nom":"Cinquième"},{"chiffre":"3","nom":"Troisième"},{"chiffre":"*","nom":"Tous"}]}},{}],67:[function(require,module,exports){module.exports={"infos":[{"msgid":"0","titre":"Message de cette application","contenu":"Ce message permet de tester le module de notification !"},{"msgid":"1","titre":"Mode d'emploi","contenu":"Vous devez sélectionner un mot !"},{"msgid":"2","titre":"Bilan","contenu":"Vous pouvez encore améliorer votre saisie."},{"msgid":"3","titre":"Bilan","contenu":"Parfait ! Aucune erreur."},{"msgid":"4","titre":"Erreur 4 dans l'application","contenu":"Le texte attendu est manquant."},{"msgid":"5","titre":"Mode d'emploi","contenu":"Aucun texte n'a été saisi."},{"msgid":"6","titre":"Assistant","contenu":"Vous n'avez pas encore remplacé toutes les lacunes."},{"msgid":"7","titre":"Assistant indisponible","contenu":"Il ne reste aucune lacune à remplacer."}]}},{}],68:[function(require,module,exports){module.exports={"rubriques":[{"lien":"apropos","legende":"À propos"},{"lien":"fabrique","legende":"Fabrique"},{"lien":"credits","legende":"Crédits"}]}},{}],69:[function(require,module,exports){module.exports={"rubriques":[{"lien":"page1","legende":"1"},{"lien":"page2","legende":"2"}]}},{}]},{},[38]);